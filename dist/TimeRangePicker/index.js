...
const TimeCell = ({
  ...
  return /*#__PURE__*/React.createElement(View, {
    className: className,
    style: [styles.time, css, background]
  }, /*#__PURE__*/React.createElement(Wrapper, wrapperProps, /*#__PURE__*/React.createElement(View, {
    style: [styles.view, Platform.OS !== 'web' ? background : null]
  })));
};
...
const TimeRangePicker = props => {
  ...
  const onEnd = end => {
    if (!disabled && !readonly) {
      ...
      const newValues = reverse ? without(values, ...range) : uniq(values.concat(range)).sort(sorter);
  ...
  const renderCell = index => /*#__PURE__*/React.createElement(TimeCell, {
    id: id,
    key: index,
    width: width,
    index: index,
  ...
  const renderHeader = index => /*#__PURE__*/React.createElement(Text, {
    key: `header-${index}`,
    type: "gray",
    style: [styles.header, {
      width: `${2 * width}%`,
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, header ? /*#__PURE__*/React.createElement(Row, {
    style: styles.headerContainer
  }, times(!(length % 2) ? length / 2 : (length + 1) / 2, renderHeader), /*#__PURE__*/React.createElement(Text, {
    type: "gray",
    style: [styles.header, {
      width: `${2 * width}%`,
      right: `-${width}%`
    }]
  }, toTime(maxTime, 'H:MMA').replace('m', '').replace(':00', ''))) : null, /*#__PURE__*/React.createElement(Row, {
