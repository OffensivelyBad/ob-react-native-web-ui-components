...
const Select = ({
  ...
  const selectStyle = [themeInputStyle.background, themeInputStyle.border, themeInputStyle.opacity];
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(Helmet, null, /*#__PURE__*/React.createElement("style", null, `
            ...
            ` : ''}
          `)), /*#__PURE__*/React.createElement(ModalPicker, {
    name: id,
    icon: "caret-down",
    type: "white",
    className: "Select__Container",
    value: value,
    style: [styles.selectContainer, auto ? styles.auto : styles.fullWidth, nomargin ? styles.noMargin : null, props.containerStyle],
