...
const Link = ({
  ...
  const currentStyle = [styles.defaults, !auto ? styles.fullWidth : null, typeof children !== 'string' ? styles.noLineHeight : null, theme.colors[type] && theme.colors[type].text, style];
  const font = {};
  const classNameProp = {};

  if (Wrapper === Text) {
    classNameProp['data-class'] = `${className} ${type}`;
    classNameProp.dataSet = {
  ...
  return /*#__PURE__*/React.createElement(Wrapper, _extends({}, classNameProp, {
